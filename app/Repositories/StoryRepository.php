...
class StoryRepository implements StoryRepositoryInterface
{
    ...
    public function allRecent($model)
    {
        if ($model == "App\Anecdote")
            return $model::select('id', 'text', 'tags', 'approvals', 'disapprovals', 'rating', 'created_at')->latest()->limit(1000)->get();
    ...
    {
        if ($model == "App\Anecdote")
            return $model::select('id', 'text', 'tags', 'approvals', 'disapprovals', 'rating', 'created_at')->orderBy('popularity', 'desc')->limit(1000)->get();
